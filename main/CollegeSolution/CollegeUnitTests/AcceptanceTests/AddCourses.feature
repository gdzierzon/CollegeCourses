Feature: AddCourses
	In order to verify courses that I have added
	As a university administrator
	I want to be shown a sequential list of my courses
...
Scenario: Add Courses to College
	...
	| Intro to Arguing on the Internet: Godwin’s Law, Understanding Circular Logic: Intro to Arguing on the Internet, Godwin’s Law: Understanding Circular Logic                                                                                                                                          | 'Understanding Circular Logic' has a prerequisite course with a circular reference.                                                                                    |